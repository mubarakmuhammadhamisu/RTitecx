    ...
    <div className="space-y-3">
      ...
      {!isCompleted ? (
        <div className="flex items-center justify-between px-1">
          ...
          <button
            onClick={onEnd}
            className="flex items-center gap-1.5 px-4 py-2 rounded-lg bg-brand-indigo-600 hover:bg-brand-indigo-700 text-white text-xs font-semibold transition active:scale-95"
          >
        ...
        <div className="flex items-center gap-1.5 px-1 text-success text-xs font-medium">
          <CheckCircle2 size={14} />
          Lesson completed
        </div>
      )}
